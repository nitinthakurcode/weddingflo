...
exports.bulkGenerateQRTokens = exports.regenerateGuestQRToken = exports.getRecentQRScans = exports.getQRScanStats = exports.checkInGuestViaQR = exports.recordQRScan = exports.validateQRToken = exports.generateGuestQRToken = void 0;
const values_1 = require("convex/values");
const server_1 = require("./_generated/server");
/**
 * Generate QR token for a guest
 */
exports.generateGuestQRToken = (0, server_1.mutation)({
    args: {
 ...
 */
exports.validateQRToken = (0, server_1.query)({
    args: {
...
exports.recordQRScan = (0, server_1.mutation)({
    args: {
        ...
        scannedBy: values_1.v.optional(values_1.v.id('users')),
    },
    handler: async (ctx, args) => {
        const guest = await ctx.db
            .query('guests')
 ...
 */
exports.checkInGuestViaQR = (0, server_1.mutation)({
    args: {
        token: values_1.v.string(),
        location: values_1.v.optional(values_1.v.object({
            lat: values_1.v.number(),
        ...
        checkedInBy: values_1.v.optional(values_1.v.id('users')),
    },
    handler: async (ctx, args) => {
        const guest = await ctx.db
            .query('guests')
 ...
 */
exports.getQRScanStats = (0, server_1.query)({
    args: {
    ...
    handler: async (ctx, args) => {
        ...
        const recentScans = guests.filter((g) => g.qr_last_scanned && g.qr_last_scanned > oneDayAgo).length;
        return {
            totalGuests,
            guestsWithScans,
            totalScans,
 ...
 * Get recent QR scans
 */
exports.getRecentQRScans = (0, server_1.query)({
    args: {
        clientId: values_1.v.id('clients'),
 ...
 */
exports.regenerateGuestQRToken = (0, server_1.mutation)({
    args: {
        guestId: values_1.v.id('guests'),
    },
    handler: async (ctx, args) => {
 ...
 */
exports.bulkGenerateQRTokens = (0, server_1.mutation)({
    args: {
        clientId: values_1.v.id('clients'),
        regenerateExisting: values_1.v.optional(values_1.v.boolean()),
    },
    handler: async (ctx, args) => {
        const guests = await ctx.db
            .query('guests')
