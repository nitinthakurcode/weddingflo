...
export async function exportVendorListExcel(
  ...
  const columns: ExcelColumn[] = [
    ...
    { header: 'Event', key: 'event', width: 20, hint: 'Event name — type to assign this vendor to an event' },
...
export async function exportGuestTransportExcel(
  ...
  const columns: ExcelColumn[] = [
    ...
    { header: 'Email Address', key: 'email', width: 28 },
    { header: 'Phone Number', key: 'phone', width: 18 },
    { header: 'Journey Type', key: 'legType', width: 18, hint: 'arrival, departure, or inter_event' },
    { header: 'Trip #', key: 'legSequence', width: 10, hint: 'Sequence number e.g. 1, 2, 3' },
    ...
    { header: 'Vehicle/Shuttle', key: 'vehicleInfo', width: 25, hint: 'e.g. Bus 1, Sedan A' },
    { header: 'Vehicle Type', key: 'vehicleType', width: 18, hint: 'e.g. sedan, van, bus, shuttle' },
