// LEGACY: Pre-Session 20 implementation
// Will be migrated to new architecture in Session 21+
// This contains: Client management, task tracking, React Query integration, etc.
'use client';
