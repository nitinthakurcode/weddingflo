...
test.describe('Authentication', () => {
  test('should load sign-in page', async ({ page }) => {
    ...
    // Wait for Clerk to fully load - check for any visible button with "Continue" or "Sign in" text
  ...
  test('should show validation errors for empty form', async ({ page }) => {
    ...
    // Find and click the submit button (Clerk's button may not have type="submit")
